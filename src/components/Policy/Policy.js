      ...
      <article>
        ...
        <section className="policy-content">
          ...
          <p className="policy-info-content">
            ...
            any disease. Always consult your physician before beginning any
            diet, supplement, or exercise regime. Pandamonium Sports Nutrition
          ...
          <p className="policy-info-content">
            ...
            other medical condition. Consult your physician prior to use if you
            are using any other medications. Do not use if you are pregnant,
            nursing, or may become pregnant. Do not use more than the
            recommended dosage. Discontinue use and consult a physician if any
            adverse reactions occur. As with all supplements: keep out of reach
